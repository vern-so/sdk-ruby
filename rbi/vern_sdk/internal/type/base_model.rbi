    ...
    module Type
      class BaseModel
        ...
        class << self
          ...
          sig { params(child: VernSDK::Internal::Type::BaseModel).void }
          def inherited(child)
          end
          ...
          sig do
            returns(
              T::Hash[
                Symbol,
                T.all(
                  VernSDK::Internal::Type::BaseModel::KnownField,
                  {
                    type_fn:
          ...
          sig do
            returns(
              T::Hash[
                ...
                T.all(
                  VernSDK::Internal::Type::BaseModel::KnownField,
                  { type: VernSDK::Internal::Type::Converter::Input }
                )
              ]
            )
          end
          ...
          sig do
            override
              .params(
                ...
                state: VernSDK::Internal::Type::Converter::CoerceState
              )
          ...
          sig do
            override
              .params(
                ...
                state: VernSDK::Internal::Type::Converter::DumpState
              )
        ...
        class << self
          ...
          sig do
            params(
              model: VernSDK::Internal::Type::BaseModel,
              convert: T::Boolean
            ).returns(VernSDK::Internal::AnyHash)
          end
        ...
        sig { overridable.returns(VernSDK::Internal::AnyHash) }
        def to_h
        end
