      ...
      class << self
        ...
        sig do
          params(url: T.any(URI::Generic, String)).returns(
            VernSDK::Internal::Util::ParsedUri
          )
        end
        def parse_uri(url)
        end
        ...
        # @api private
        sig do
          params(parsed: VernSDK::Internal::Util::ParsedUri).returns(
            URI::Generic
          )
        end
        ...
        sig do
          params(
            lhs: VernSDK::Internal::Util::ParsedUri,
            rhs: VernSDK::Internal::Util::ParsedUri
          ).returns(URI::Generic)
        end
      ...
      class << self
        ...
        sig do
          params(lines: T::Enumerable[String]).returns(
            T::Enumerable[VernSDK::Internal::Util::ServerSentEvent]
          )
        end
      ...
      module SorbetRuntimeSupport
        ...
        class << self
          ...
          sig do
            params(
              type:
                T.any(VernSDK::Internal::Util::SorbetRuntimeSupport, T.anything)
            ).returns(T.anything)
          end
