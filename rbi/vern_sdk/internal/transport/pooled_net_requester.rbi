      ...
      class PooledNetRequester
        ...
        class << self
          ...
          sig do
            params(
              request:
                VernSDK::Internal::Transport::PooledNetRequester::Request,
        ...
        sig do
          params(
            request: VernSDK::Internal::Transport::PooledNetRequester::Request
        ...
        def self.new(
          size: VernSDK::Internal::Transport::PooledNetRequester::DEFAULT_MAX_CONNECTIONS
        )
        end
      end
    end
