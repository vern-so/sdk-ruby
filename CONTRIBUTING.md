...
Most of the SDK is generated code. Modifications to code will be persisted between generations, but may result in merge conflicts between manual patches and changes from the generator. The generator will never modify the contents of `lib/vern_sdk/helpers/` and `examples/` directory.
...
```ruby
gem "vern-sdk", git: "https://www.github.com/stainless-sdks/vern-sdk-ruby"
```

Alternatively, reference local copy of the repo:

```bash
$ git clone -- 'https://www.github.com/stainless-sdks/vern-sdk-ruby' '<path-to-repo>'
```

```ruby
gem "vern-sdk", path: "<path-to-repo>"
```
