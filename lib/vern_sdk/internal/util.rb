    ...
    module Util
      ...
      class << self
        ...
        def coerce_hash!(input)
          ...
          in Hash | nil => coerced
            ...
            message = "Expected a #{Hash} or #{VernSDK::Internal::Type::BaseModel}, got #{input.inspect}"
      ...
      class << self
        ...
        def encode_path(path)
          path.to_s.gsub(VernSDK::Internal::Util::RFC_3986_NOT_PCHARS) { ERB::Util.url_encode(_1) }
        end
      ...
      class << self
        ...
        private def write_multipart_chunk(y, boundary:, key:, val:, closing:)
          ...
          case val
          in VernSDK::FilePart unless val.filename.nil?
          ...
          strio = writable_enum do |y|
            ...
            in Hash
              body.each do |key, val|
                case val
                in Array if val.all? { primitive?(_1) || VernSDK::Internal::Type::FileInput === _1 }
                  val.each do |v|
        ...
        def encode_content(headers, body)
          ...
          in [VernSDK::Internal::Util::JSON_CONTENT, Hash | Array | -> { primitive?(_1) }]
            [headers, JSON.generate(body)]
          in [VernSDK::Internal::Util::JSONL_CONTENT, Enumerable] unless VernSDK::Internal::Type::FileInput === body
            [headers, body.lazy.map { JSON.generate(_1) }]
          in [%r{^multipart/form-data}, Hash | VernSDK::Internal::Type::FileInput]
        ...
        def decode_content(headers, stream:, suppress_error: false)
          ...
          in VernSDK::Internal::Util::JSON_CONTENT
          ...
          in VernSDK::Internal::Util::JSONL_CONTENT
      ...
      module SorbetRuntimeSupport
        ...
        class << self
          # @api private
          #
          # @param type [VernSDK::Internal::Util::SorbetRuntimeSupport, Object]
          #
          # @return [Object]
          def to_sorbet_type(type)
            case type
            in VernSDK::Internal::Util::SorbetRuntimeSupport
              type.to_sorbet_type
            in Class | Module
              type
            in true | false
