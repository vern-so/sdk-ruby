    ...
    module Type
      ...
      class BaseModel
        ...
        class << self
          ...
          private def add_field(name_sym, required:, type_info:, spec:)
            ...
            define_method(setter) do |value|
              target = type_fn.call
              state = VernSDK::Internal::Type::Converter.new_coerce_state(translate_names: false)
              ...
              stored =
                case [target, status]
                in [VernSDK::Internal::Type::Converter | Symbol, true]
                  coerced
                else
                  value
                end
            ...
            define_method(name_sym) do
              ...
              in true | false if VernSDK::Internal::Type::Converter === target
                @data.fetch(name_sym)
              in ::StandardError => e
                raise VernSDK::Errors::ConversionError.new(
                  on: self.class,
                  method: __method__,
                  target: target,
        ...
        def initialize(data = {})
          @data = {}
          @coerced = {}
          VernSDK::Internal::Util.coerce_hash!(data).each do
