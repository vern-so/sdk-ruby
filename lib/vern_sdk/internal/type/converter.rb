    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { VernSDK::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { VernSDK::Internal::Type::Unknown.dump(_1, state: state) }
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in VernSDK::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [VernSDK::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: VernSDK::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in VernSDK::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in VernSDK::Internal::Type::Converter
              ...
              VernSDK::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(VernSDK::Internal::Type::Converter, T::Class[T.anything]) }
        end
