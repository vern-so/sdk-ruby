  ...
  module Internal
    module Type
      ...
      module Union
        ...
        # @api private
        #
        # @param key [Symbol, Hash{Symbol=>Object}, Proc, VernSDK::Internal::Type::Converter, Class]
        #
        # @param spec [Hash{Symbol=>Object}, Proc, VernSDK::Internal::Type::Converter, Class] .
        #
        ...
        # @param value [Object]
        #
        # @return [VernSDK::Internal::Type::Converter, Class, nil]
        private def resolve_variant(value)
          case [@discriminator, value]
          in [_, VernSDK::Internal::Type::BaseModel]
            value.class
          in [Symbol, Hash]
            key = value.fetch(@discriminator) do
              value.fetch(@discriminator.to_s, VernSDK::Internal::OMIT)
            end
        ...
        # @return [Boolean]
        def ==(other)
          VernSDK::Internal::Type::Union === other && other.derefed_variants == derefed_variants
        end
        ...
        def coerce(value, state:)
          if (target = resolve_variant(value))
            return VernSDK::Internal::Type::Converter.coerce(target, value, state: state)
          end
          ...
          known_variants.each do |_, variant_fn|
            ...
            coerced = VernSDK::Internal::Type::Converter.coerce(target, value, state: state)
        ...
        def dump(value, state:)
          if (target = resolve_variant(value))
            return VernSDK::Internal::Type::Converter.dump(target, value, state: state)
          end

          known_variants.each do
            target = _2.call
            return VernSDK::Internal::Type::Converter.dump(target, value, state: state) if target === value
          end
        ...
        def inspect(depth: 0)
          ...
          members = variants.map { VernSDK::Internal::Type::Converter.inspect(_1, depth: depth.succ) }
