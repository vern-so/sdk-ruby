...
module VernSDK
  module Internal
    module Type
      ...
      # `VernSDK::Internal::Type::FileInput`.
      #
      ...
      class FileInput
        ...
        def self.===(other)
          case other
          in Pathname | StringIO | IO | String | VernSDK::FilePart
            true
          else
            false
          end
        ...
        #
        # @return [Boolean]
        def self.==(other) = other.is_a?(Class) && other <= VernSDK::Internal::Type::FileInput
        ...
        class << self
          ...
          # @return [Object]
          def to_sorbet_type
            T.any(Pathname, StringIO, IO, String, VernSDK::FilePart)
          end
        end
      end
    end
