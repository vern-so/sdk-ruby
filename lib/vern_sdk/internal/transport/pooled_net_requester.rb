      ...
      class PooledNetRequester
        ...
        class << self
          ...
          def calibrate_socket_timeout(conn, deadline)
            timeout = deadline - VernSDK::Internal::Util.monotonic_secs
        ...
        private def with_pool(url, deadline:, &blk)
          origin = VernSDK::Internal::Util.uri_origin(url)
          timeout = deadline - VernSDK::Internal::Util.monotonic_secs
          pool =
        ...
        def execute(request)
          ...
          enum = Enumerator.new do |y|
            ...
            raise VernSDK::Errors::APITimeoutError.new(url: url, request: req)
          rescue StandardError
            raise VernSDK::Errors::APIConnectionError.new(url: url, request: req)
          end
