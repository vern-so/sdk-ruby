...
class VernSDKTest < Minitest::Test
  ...
  def test_client_default_request_default_retry_attempts
    stub_request(:post, "http://localhost/runs").to_return_json(status: 500, body: {})

    vern = VernSDK::Client.new(base_url: "http://localhost", api_key: "My API Key")
  ...
  def test_client_given_request_default_retry_attempts
    ...
    vern = VernSDK::Client.new(base_url: "http://localhost", api_key: "My API Key", max_retries: 3)
  ...
  def test_client_default_request_given_retry_attempts
    ...
    assert_raises(VernSDK::Errors::InternalServerError) do
      vern.runs.create(task_id: "task_123456", request_options: {max_retries: 3})
    end
  ...
  def test_client_given_request_given_retry_attempts
    ...
    assert_raises(VernSDK::Errors::InternalServerError) do
      vern.runs.create(task_id: "task_123456", request_options: {max_retries: 4})
    end
  ...
  def test_client_redirect_307
    ...
    assert_raises(VernSDK::Errors::APIConnectionError) do
      vern.runs.create(task_id: "task_123456", request_options: {extra_headers: {}})
    end

    recorded, = WebMock::RequestRegistry.instance.requested_signatures.hash.first

    assert_requested(:any, "http://localhost/redirected", times: VernSDK::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_303
    ...
    assert_requested(:get, "http://localhost/redirected", times: VernSDK::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_auth_strip_cross_origin
    ...
    assert_requested(:any, "https://example.com/redirected", times: VernSDK::Client::MAX_REDIRECTS) do
      headers = _1.headers.keys.map(&:downcase)
  ...
  def test_default_headers
    stub_request(:post, "http://localhost/runs").to_return_json(status: 200, body: {})
