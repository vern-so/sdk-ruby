...
class VernSDK::Test::SingletonClient < VernSDK::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: VernSDK::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class VernSDK::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @vern = VernSDK::Test::SingletonClient.instance
  end
